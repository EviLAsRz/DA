...
void DEF_LIB_EXPORTED placeDefenses3(bool** freeCells, int nCellsWidth, int nCellsHeight, float mapWidth, float mapHeight
    ...
    std::list<Cell> auxList(Cells.begin(), Cells.end());       //Creamos una lista con las celdas
    auxList.sort();                                            //utilizamos sort para ordenarlas(O n·log n)
    Cells = std::vector<Cell>(auxList.begin(),auxList.end()); //Copiamos la lista ordenada de nuevo en el vector de celdas

    /*..............................[ORDENACION POR ORDENACION RAPIDA O QUICKSORT]..................................................*/
